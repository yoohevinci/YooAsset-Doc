...
[YooAsset.Editor.CollectResult](/docs/api/YooAsset.Editor/CollectResult): 资源收集结果
##### Parameters
...
[YooAsset.Editor.BundleCollectorPackage](/docs/api/YooAsset.Editor/BundleCollectorPackage): 包裹对象
##### Parameters
