...
[YooAsset.Editor.BundlePackRuleResult](/docs/api/YooAsset.Editor/BundlePackRuleResult): 着色器资源包的打包规则结果### CreateMonosPackRuleResult()
创建脚本资源包的打包结果
...
[YooAsset.Editor.BundlePackRuleResult](/docs/api/YooAsset.Editor/BundlePackRuleResult): 脚本资源包的打包规则结果